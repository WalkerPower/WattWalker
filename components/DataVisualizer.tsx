            ...
            {canSave && (
                <div className="flex flex-col items-end gap-3">
                    ...
                    <button 
                        ...
                        className={`flex items-center gap-1.5 px-4 py-2 text-sm font-bold rounded-lg border transition-colors shadow-sm ${
                        saveStatus === 'saved' 
                ...
                <tbody className="bg-white">
                    {tableData.map((row, index) => (
                        <tr key={index} className="border-b border-slate-200 hover:bg-slate-50">
                            <td className="px-4 py-2 border border-slate-300 text-slate-900 text-lg font-semibold">
                                {formatMonthName(row.month)}
                            </td>
                            <td className="px-4 py-2 border border-slate-300 text-center text-slate-700 font-medium text-lg">
                                {row.adjustedDailyUsage}
                            </td>
                    ...
                    <tr className="bg-blue-50 border-t-2 border-slate-800">
                        <td className="px-4 py-3 border border-slate-800 text-slate-900 font-extrabold text-lg">
                            Avg $/month
                        </td>
                        <td className="px-4 py-3 border border-slate-800 text-center text-slate-900 font-bold text-lg">
                            ${financialSummary.avgCost.toFixed(0)}
                        </td>
                         <td className="px-4 py-3 border border-slate-800 text-center text-slate-900 font-extrabold text-lg">
                            Total $/y
                        </td>
                        <td className="px-4 py-3 border border-slate-800 text-center text-slate-900 font-extrabold text-lg">
                            ${financialSummary.totalCost.toLocaleString('en-US', { maximumFractionDigits: 0 })}
                        </td>
                    </tr>
                </tbody>
             </table>
